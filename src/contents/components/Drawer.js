  ...
  const code = (
    <div>
      <div className="mt-8 flex h-40 bg-bgPrimary">
        ...
        <div className="fixed left-0 top-0 flex h-screen w-72 -translate-x-full flex-col bg-secondary transition-transform duration-1000 peer-checked:translate-x-0">
